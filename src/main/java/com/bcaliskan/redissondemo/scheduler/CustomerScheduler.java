package com.bcaliskan.redissondemo.scheduler;

import com.bcaliskan.redissondemo.configuration.RedisProperties;
import com.bcaliskan.redissondemo.model.Customer;
...
public class CustomerScheduler {
    ...
    @Scheduled(fixedDelayString = "${redisson-demo.redis.fixedDelayMillis}")
